...
notas.onclick = function clear() {
 ...
 <div class="bt">
    ...
    <p class="m-title">CONTROLE DENOTAS FISCAIS<br>PARA PAGAMENTO</p>
</div>
...
<div class="bt">
    <a class="link-bt" href="https://script.google.com/macros/s/AKfycbxceSHNIVMzHCLD4200LQ-GtQTbmb9m5pkq2GawxwbwgbnZytozoqld3-WXhMFCfYC_Vw/exec" target="_blank">
        <div>
            <img class="logo-pnm"
                src="./img/siclop_BT.png"
                alt="logo Pedido">

        </div>
    </a>
    <p class="m-title">CONTROLE DE <br>PEDIDOS (V2)</p>
</div>
...
coord.onclick = function clear() {
    ...
    <p class="m-title">DASHBOARDS DE <br>OFS, ENTREGAS, <br>QUARENTENAS E AGENDAMENTOS </p>
</div>
